...
struct eeprom_layout __default_eep__  = {
  ...
  cfg: {
    rcp_min_us:      RCP_MIN,
    rcp_max_us:      RCP_MAX,
    rcp_full_rev_us: RCP_START,
    rcp_start_us:    RCP_START,
    rcp_full_fwd_us: RCP_FULL,
    rcp_cal_us:      0,
...
struct eeprom_layout __free_flight_eep__  = {
  ...
  cfg: {
    rcp_min_us:      800,
    rcp_max_us:      2200,
    rcp_full_rev_us: 1188,
    rcp_start_us:    1188,
    rcp_full_fwd_us: 1650,
    rcp_cal_us:      900,
    rcp_deadband_us: 5,
    braking:         0,
    timing_adv:      0,
...
struct eeprom_layout __multiwii_eep__  = {
  ...
  cfg: {
    rcp_min_us:      900,
    rcp_max_us:      2200,
    rcp_full_rev_us: 1140,
    rcp_start_us:    1140,
    rcp_full_fwd_us: 1850,
    rcp_cal_us:      1000,
    rcp_deadband_us: 5,
    braking:         0,
    timing_adv:      0,
